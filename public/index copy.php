...
<head>
    <meta charset="utf-8">
    <title>PKBM - Langgeng Ikhlas</title>
    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        <div class="top-bar row gx-0 align-items-center d-none d-lg-flex">
            <div class="col-lg-6 px-5 text-start">
                <small><i class="fa fa-map-marker-alt text-primary me-2"></i><a href="https://goo.gl/maps/AUyzQf2Pv6x26PiB7"> Jl. Bakti No.29, Bojongsari Baru</a></small>
                <small class="ms-4"><i class="fa fa-clock text-primary me-2"> <span id="digital-clock"></span></i></small>
            </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            <a href="index.html" class="navbar-brand ms-4 ms-lg-0">
                <h1 class="display-7 text-primary m-0">LANGGENG IKHLAS</h1>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="service.html" class="nav-item nav-link">Agenda</a>
